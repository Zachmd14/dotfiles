...
echo "Tasks :"
todoist-cli --color --indent l -p -f "#computer"
...
if status is-interactive
    ...
    abbr discord './Apps/Discord/Discord'
    abbr bt 'bluetuith'
    abbr cal 'gcalcli'
	...
	abbr df 'git --git-dir=$HOME/dotfiles/ --work-tree=$HOME'
    abbr em 'emacsclient -c -a "" -n'
end
